...
raw = io.Raw('/Users/ordez/mne_data/MNE-sample-data/MEG/sample/sample_audvis_filt-0-40_raw.fif', preload=True, verbose=False)
raw.filter(2, None, method='iir')  # replace baselining with high-pass
events = mne.read_events('/Users/ordez/mne_data/MNE-sample-data/MEG/sample/sample_audvis_filt-0-40_raw-eve.fif')
